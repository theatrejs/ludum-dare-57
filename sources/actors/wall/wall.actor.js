...
import * as ACTIONS from './wall.actions.js';
import * as STATES from './wall.states.js';
import asepriteWall from './spritesheets/wall.aseprite';
 ...
 */
class ActorWall extends FACTORIES.ActorWithPreloadables([

    PLUGIN_ASEPRITE.FACTORIES.PreloadableAseprite(asepriteWall),
    ...
    onCreate() {
        ...
        this.$spritesheet = new PLUGIN_ASEPRITE.Spritesheet(/** @type {PLUGIN_ASEPRITE.Aseprite<TypeTagAseprite>} **/(asepriteWall));
