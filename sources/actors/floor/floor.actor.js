...
import * as ACTIONS from './floor.actions.js';
import * as STATES from './floor.states.js';
import asepriteFloor from './spritesheets/floor.aseprite';
 ...
 */
class ActorFloor extends FACTORIES.ActorWithPreloadables([

    PLUGIN_ASEPRITE.FACTORIES.PreloadableAseprite(asepriteFloor),
    ...
    onCreate() {
        ...
        this.$spritesheet = new PLUGIN_ASEPRITE.Spritesheet(/** @type {PLUGIN_ASEPRITE.Aseprite<TypeTagAseprite>} **/(asepriteFloor));
